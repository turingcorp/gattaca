...
+(void)create
{
    ...
    query = @"CREATE TABLE profile (id INTEGER PRIMARY KEY, created INTEGER, syncstamp INTEGER, updated INTEGER, name INTEGER, namestr TEXT COLLATE NOCASE, age INTEGER);";
