...
-(instancetype)init:(cconfigsettingsdelete*)controller
{
    ...
    [delete setTitleColor:[UIColor colorWithWhite:1 alpha:0.1] forState:UIControlStateHighlighted];
    ...
    [self addConstraints:[NSLayoutConstraint constraintsWithVisualFormat:@"V:[cancel(34)]-15-[delete(34)]-20-|" options:0 metrics:metrics views:views]];
